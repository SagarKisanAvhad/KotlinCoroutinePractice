...
1) [Coroutines internal working part 1](https://www.youtube.com/watch?v=_hfBv0a09Jc&list=RDCMUCGp4UBwpTNegd_4nCpuBcow&index=2) - shared by Atul Kumar. best video.
2) [Coroutines internal working part 2](https://www.youtube.com/watch?v=YrrUCSi72E8&list=RDCMUCGp4UBwpTNegd_4nCpuBcow&index=3) - shared by Atul Kumar. best video.
3) [Coroutines under the hood](https://kt.academy/article/cc-under-the-hood) - Kt Academy
4) [How does suspension work in Kotlin coroutines?](https://kt.academy/article/cc-suspension) - Kt Academy
5) [Suspend function under the hood simple article](https://betterprogramming.pub/kotlin-coroutine-internals-49518ecf2977) - shared by Athul Antony
6) [Flow, StateFlow, shared flow testing emitting and collecting side](https://codingwithmohit.com/coroutines/learning-shared-and-state-flows-with-tests/) - coding with mohit. After 2 days struggle, finally found.
7) [Kotlin coroutine Use cases example](https://github.com/LukasLechnerDev/Kotlin-Coroutine-Use-Cases-on-Android) - LukasLechnerDev GitHub
8) [Kotlin coroutine](https://magdamiu.medium.com/kotlin-coroutines-7938b5c7a11b)- medium article by Magda Miu
9) [Android developer medium](https://medium.com/androiddevelopers/coroutines-on-android-part-i-getting-the-background-3e0e54d20bb)- Neeraj shared
10) [Android developer medium](https://medium.com/androiddevelopers/exceptions-in-coroutines-ce8da1ec060c)- Neeraj shared
11) [Roman](https://elizarov.medium.com/?source=post_page-----f2cc748b2401--------------------------------) - Neeraj shared
12) [Asynchronous programming](https://www.bmc.com/blogs/asynchronous-programming/) - beautiful blog by bmc. general concept.
